  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Agreed hourly/labour rates for this agreement. Only one rate can be marked as default.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {isLoading ? (
          ...
          <p className="text-sm text-muted-foreground text-center py-4">No labour rates yet.</p>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
